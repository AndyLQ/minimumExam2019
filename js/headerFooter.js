...
footer.innerHTML = ' <section class="footercontent"> <div class="footeritem1"> <a href="#">subscribe to our newsletter</a> <br> <br> <a href="faq.html">faq</a> <br> <br> <br class="poof"> <a href="" class="poof"> <button id="footerbtn">download social media content</button></a> <br class="poof"> <br class="poof"> <a href="" class="poof"> <button id="footerbtn">download website content</button></a> </div> <div class="footeritem2"> <div id="some twos" class="poof" style="text-align: center;"> <a href="http:\\www.facebook.com" target="_blank"> <i class="ill fab fa-facebook-square"> </i> </a> <a href="http:\\www.instagram.com" target="_blank"> <i class="ill fab fa-instagram"> </i> </a> <a href="mailto:"> <i class="ill fas fa-envelope"> </i> </a> </div> <div id="some twos" class="swush" style="text-align: center;"> <a href="http:\\www.facebook.com" target="_blank"> <i class="ill fab fa-facebook-square"> </i> </a> <a href="http:\\www.instagram.com" target="_blank"> <i class="ill fab fa-instagram"> </i> </a> <a href="mailto:"> <i class="ill fas fa-envelope"> </i> </a> </div> </div> <div id="snot"></div> <div class="footeritem3"> <div id="ci2"> <p>contact information</p> </div> <section id="omitem1"> <ul> <li>minimum a/s</li> <li>balticagade 16, hal 3 &amp; 4</li> <li>8000 aarhus c</li> <li>danmark</li> <br> <li>+0045 7025 0531</li> <li>contact@minimum.dk</li> </ul> </section> </div> </section>';
